...
class PublicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Publication
        fields = [
            'id', 'prestataire', 'prestataire_nom', 'type_publication', 'contenu',
            'image', 'service_associe', 'nombre_likes', 'nombre_commentaires',
            'jaime_deja', 'date_creation', 'date_modification',
        ]
