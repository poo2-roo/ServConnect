...
const styles = StyleSheet.create({
  ...
  zoneSaisie: { flexDirection: 'row', alignItems: 'flex-end', padding: espacements.sm, paddingBottom: Platform.OS === 'ios' ? 20 : 70, marginBottom: espacements.sm, backgroundColor: couleurs.blanc, borderTopWidth: 2, borderTopColor: couleurs.bordure, gap: espacements.xs },
